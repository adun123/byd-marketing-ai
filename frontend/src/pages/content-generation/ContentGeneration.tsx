      ...
      <div className="grid w-full grid-cols-1 gap-4 px-4 py-6 lg:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <section className="min-w-0 flex flex-col">
              ...
              {items.length === 0 ? (
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  {items.map((it) => (
                    ...
                    >
                      {/* Preview */}
                      <div className="mb-2 aspect-video overflow-hidden rounded-xl border border-slate-200 bg-slate-100">
                        {it.imageUrl ? (
                          <img
                            src={it.imageUrl}
                            alt="Generated"
                      ...
                      {/* Prompt text */}
                      <div className="text-xs font-semibold text-slate-900">Prompt</div>
          ...
          <div className="sticky bottom-3">
            <div className="rounded-2xl border border-slate-200 bg-white/85 shadow-lg backdrop-blur">
              <Composer
                prompt={prompt}
                setPrompt={setPrompt}
